		...
		<form action="/create_account" method="post" enctype="multipart/form-data"> 
			<fieldset class="fieldset-auto-width">
				...
				<fieldset style="width:500px">
					<legend>
						<input type="radio" name = "keyChoice" id = "keyChoice" value = "upload" checked onclick = "uploadButton(); checkFields()"/>Upload <b>Public</b> Key
					</legend>
				...
				<fieldset style="width:500px">
					<legend>
						<input type="radio" name = "keyChoice" id = "keyChoice" value = "generate" onclick = "generateButton(); checkFields()"/>Generate Key Pair
					</legend>
